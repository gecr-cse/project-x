 ...
 * Author: <Name> <Sem>
 * Purpose : This page is edit the student
				...
				<!-- BEGIN SAMPLE FORMPORTLET-->
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-edit"></i> Student Info Edit. </h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
							<form action="<?php echo ADMIN_BASE_URL; ?>system/controller/student-controller.php?action=editStudent" name="student_add" class="form-horizontal" method="post">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span6  tooltips"  required data-trigger="hover" data-original-title="Students Name." value="<?php echo $student_det[0]['name'];?>" name="name"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Student Role Number</label>
									<div class="controls">
										<input type="text" class="span6  tooltips"  required data-trigger="hover" data-original-title="Student Role Number." value="<?php echo $student_det[0]['roll_no'];?>" name="role_no"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Student Mobile Number</label>
									<div class="controls">
										<input type="text" class="span6  tooltips"  required data-trigger="hover" data-original-title="Student Mobile Number." value="<?php echo $student_det[0]['mobile'];?>" name="mobile"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Student Email</label>
									<div class="controls">
										<input type="text" class="span6  tooltips"  required data-trigger="hover" data-original-title="Student Email." value="<?php echo $student_det[0]['email'];?>" name="email"/>
									</div>
								</div>
