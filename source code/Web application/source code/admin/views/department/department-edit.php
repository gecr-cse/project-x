 ...
 * Author: <Name> <Sem>
 * Purpose : This page is used to edit the department
				...
				<!-- BEGIN SAMPLE FORMPORTLET-->
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-edit"></i> Department Info Edit. </h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
							<form action="<?php echo ADMIN_BASE_URL;?>system/controller/department-controller.php?action=updateDepartment" name="dept_edit" class="form-horizontal" method="post" enctype="multipart/form-data">
								<input type="hidden" name="dept_id" value="<?php echo $detp_details[0]['dept_id'];?>"/>
								<div class="control-group">
									<label class="control-label">Department Name</label>
									<div class="controls">
										<input type="text" class="span6  tooltips" data-trigger="hover"  required data-original-title="Students Name." value="<?php echo $detp_details[0]['dept_name'];?>" name="dept_name"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Upload Dept image</label>
									<div class="controls">
										<input type="file" class="span6  tooltips" data-trigger="hover"  required data-original-title="Upload Dept image." value="" name="image"/>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span6  tooltips" data-trigger="hover"  required data-original-title="Department HOD Name." value="<?php echo $detp_details[0]['dept_hod_name'];?>" name="dept_hod_name"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Department HOD Number</label>
									<div class="controls">
										<input type="text" class="span6  tooltips" data-trigger="hover"  required data-original-title="Department HOD Number." value="<?php echo $detp_details[0]['dept_hod_no'];?>" name="dept_hod_no"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Department HOD email</label>
									<div class="controls">
										<input type="text" class="span6  tooltips" data-trigger="hover"  required data-original-title="Department HOD email." value="<?php echo $detp_details[0]['dept_hod_email'];?>" name="dept_hod_email"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Department Strength</label>
									<div class="controls">
										<input type="text" class="span6  tooltips" data-trigger="hover"  required data-original-title="Department Strength." value="<?php echo $detp_details[0]['dept_strength'];?>" name="dept_hod_strength"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Department Staff</label>
									<div class="controls">
										<input type="text" class="span6  tooltips" data-trigger="hover"  required data-original-title="Department Staff." value="<?php echo $detp_details[0]['dept_staff'];?>" name="dept_hod_staff"/>
									</div>
								</div>
								<!--<div class="control-group">
